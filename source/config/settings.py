...
CORS_ALLOW_ALL_ORIGINS = env_bool("CORS_ALLOW_ALL_ORIGINS", ENVIRONMENT != "production")
CORS_ALLOW_CREDENTIALS = env_bool("CORS_ALLOW_CREDENTIALS", ENVIRONMENT != "production")
CORS_ALLOW_PRIVATE_NETWORK = env_bool("CORS_ALLOW_PRIVATE_NETWORK", ENVIRONMENT != "production")
